...
public class AgenciaRestController
{
    ...
    public ResponseEntity<ResponseReservationDTO>reservacion(@Valid @RequestBody PayloadDTO payloadDTO)
    {
    ...
    public ResponseEntity<ResponseReservationVueloDTO>reservacionVuelo(@Valid @RequestBody PayloadFlightDTO payloadFlightDTO)
    {
